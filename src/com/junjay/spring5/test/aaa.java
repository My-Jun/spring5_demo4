...
public class aaa {
	 ...
	 public static void main(String[] args) throws Exception{
			...
			HTTP_BACK_MESSAGE = HTTP_POST("https://service.winic.org/sys_port/gateway/index.asp", "id=JunJay&pwd=niuJunJay&to=17600211647&content=" + URLEncoder.encode("您好，您的验证码是2【中正云通信】", "gb2312") + "&time=");
